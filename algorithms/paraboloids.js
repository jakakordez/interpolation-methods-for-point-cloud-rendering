...
class App {
	...
	constructor(canvas) {
		...
		let LAS = new RC.LASLoader(this.loadingManager, "arraybuffer", true, 128*1024*1024);
		LAS.load(
			//url
			...
			function(data){
				...
				let pointCloudMaterial = new RC.CustomShaderMaterial("pointcloud", {"paraboloidSlope": 5.0});
				pointCloudMaterial.flags.push("PARABOLOIDS");
				...
				pointCloudMaterial.pointSize = 600.0;
