	...
	constructor(canvas) {
		...
		LAS.load(
			...
			function(data){
				...
				pointCloudMaterial.pointSize = 100.0;
		...
		var weightedDistanceMaterial = new RC.CustomShaderMaterial("weightedDistance", {imageHeight: imageHeight, imageWidth: imageWidth});
