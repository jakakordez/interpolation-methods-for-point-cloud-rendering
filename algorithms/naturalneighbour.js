...
class App {
	...
	constructor(canvas) {
		...
		var finalMaterial = new RC.CustomShaderMaterial("naturalNeighbour", 
			{
				imageHeight: imageHeight, 
				imageWidth: imageWidth,
			}
		...
		var finalPass = new RC.RenderPass(
            ...
            // Preprocess function
            function (textureMap, additionalData) {
                return {material: finalMaterial, textures: [textureMap['positions'], textureMap['diffuse'], textureMap['coordinates0']]};
            },
		...
		this.keyboardInput.addListener(function (pressedKeys) {
			...
			if (pressedKeys.has(80) && !screenShot) {
				...
				rc.downloadTexture("coordinates0"); 
