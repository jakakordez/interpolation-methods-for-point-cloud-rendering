...
import {FRONT_AND_BACK_SIDE, FRONT_SIDE, BACK_SIDE, FUNC_LEQUAL, FUNC_LESS, FUNC_GEQUAL, FUNC_GREATER, FUNC_EQUAL, FUNC_NOTEQUAL, POINTS, LINES, LINE_LOOP, LINE_STRIP, TRIANGLES, TRIANGLE_STRIP, TRIANGLE_FAN} from '../constants.js';
...
export class MeshRenderer extends Renderer {
				...
				default:
					...
					if (customAttributes !== undefined) {
						...
						if (attr !== undefined) {
							...
							attributeSetter[attributes[i]].set(buffer, attr.itemSize);
						}
					}
	...
	_setup_material_settings(material) {
		...
		this._setup_material_blending(material.blending, material.blendFunction, 
			material.blendSrcRGB, material.blendDstRGB, material.blendSrcA, material.blendDstA);
	}
	...
	_setup_material_blending(blending, blendFunc, srcRgb, dstRgb, srcA, dstA){
		if(blending){
			this._gl.enable(this._gl.BLEND);
			this._gl.blendEquation(blendFunc);
			this._gl.blendFuncSeparate(srcRgb, dstRgb, srcA, dstA);
		}
		else{
			this._gl.disable(this._gl.BLEND);
		}
