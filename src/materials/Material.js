...
export class Material {
	...
	set blending(val) {
		if (val !== this._blending) {
			this._blending = val;

			// Notify onChange subscriber
			if (this._onChangeListener) {
				var update = {uuid: this._uuid, changes: {blending: this._blending}};
				this._onChangeListener.materialUpdate(update)
			}
		}
	}

	set blendFunction(val) {
		if (val !== this._blendFunction) {
			this._blendFunction = val;

			// Notify onChange subscriber
			if (this._onChangeListener) {
				var update = {uuid: this._uuid, changes: {blendFunction: this._blendFunction}};
				this._onChangeListener.materialUpdate(update)
			}
		}
	}
	...
	set blendSrcRGB(val) {
		if (val !== this._blendSrcRGB) {
			this._blendSrcRGB = val;

			// Notify onChange subscriber
			if (this._onChangeListener) {
				var update = {uuid: this._uuid, changes: {blendSrcRGB: this._blendSrcRGB}};
				this._onChangeListener.materialUpdate(update)
			}
		}
	}
	...
	set blendDstRGB(val) {
		if (val !== this._blendDstRGB) {
			this._blendDstRGB = val;

			// Notify onChange subscriber
			if (this._onChangeListener) {
				var update = {uuid: this._uuid, changes: {blendDstRGB: this._blendDstRGB}};
				this._onChangeListener.materialUpdate(update)
			}
		}
	}
	...
	set blendSrcA(val) {
		if (val !== this._blendSrcA) {
			this._blendSrcA = val;

			// Notify onChange subscriber
			if (this._onChangeListener) {
				var update = {uuid: this._uuid, changes: {blendSrcA: this._blendSrcA}};
				this._onChangeListener.materialUpdate(update)
			}
		}
	}
	...
	set blendDstA(val) {
		if (val !== this._blendDstA) {
			this._blendDstA = val;

			// Notify onChange subscriber
			if (this._onChangeListener) {
				var update = {uuid: this._uuid, changes: {blendDstA: this._blendDstA}};
				this._onChangeListener.materialUpdate(update)
			}
		}
	}
	...
	get blendFunction() { return this._blendFunction; }
	get blendSrcRGB() { return this._blendSrcRGB; }
	get blendDstRGB() { return this._blendDstRGB; }
	get blendSrcA() { return this._blendSrcA; }
	get blendDstA() { return this._blendDstA; }
	...
	toJson() {
		...
		obj.blending = this._blending;
		obj.blendFunction = this._blendFunction;
		obj.blendSrcRGB = this._blendSrcRGB;
		obj.blendDstRGB = this._blendDstRGB;
		obj.blendSrcA = this._blendSrcA;
		obj.blendDstA = this._blendDstA;
	...
	static fromJson(obj, material) {
		...
		material._blending = obj.blending;
		material._blendFunction = obj.blendFunction;
		material._blendSrcRGB = obj.blendSrcRGB;
		material._blendDstRGB = obj.blendDstRGB;
		material._blendSrcA = obj.blendSrcA;
		material._blendDstA = obj.blendDstA;
		...
		for (var prop in data) {
			switch (prop) {
				...
				case "blending":
					...
					break;
				case "blendFunction":
					this._blendFunction = data.blendFunction;
					delete data.blendFunction;
					break;
				case "blendSrcRGB":
					this._blendSrcRGB = data.blendSrcRGB;
					delete data.blendSrcRGB;
					break;
				case "blendDstRGB":
					this._blendDstRGB = data.blendDstRGB;
					delete data.blendDstRGB;
					break;
				case "blendSrcA":
					this._blendSrcA = data.blendSrcA;
					delete data.blendSrcA;
					break;
				case "blendDstA":
					this._blendDstA = data.blendDstA;
					delete data.blendDstA;
					break;
